            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mb-8 text-center flex flex-col items-center">
                {forgotMode ? (
                  ...
                  <>
                    <h1 className="text-4xl md:text-5xl font-normal tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400 whitespace-nowrap">Welcome back</h1>
                    <p className="mt-3 text-neutral-400 text-sm max-w-sm text-balance">

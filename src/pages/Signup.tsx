...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black text-white flex flex-col justify-center">
      ...
      <main className="relative z-10 mx-auto w-full max-w-sm px-6 py-12">
        <motion.div
        ...
        >
          {/* Badge / Notice */}
          <motion.div variants={transitionVariants} className="mb-6">
            <Link
              to="/login"
              className="group mx-auto flex w-fit items-center gap-4 rounded-full border border-white/10 bg-white/5 p-1 pl-4 shadow-md transition-all duration-300 hover:bg-white/10"
            >
              <span className="text-xs font-medium text-neutral-300">Already have an account?</span>
              <span className="block h-3 w-0.5 border-l border-white/20 bg-white/20"></span>
              <div className="flex size-5 items-center justify-center overflow-hidden rounded-full bg-white/10 duration-500 group-hover:bg-white/20">
          ...
          {/* Signup Form */}
          <motion.div variants={transitionVariants} className="w-full">
